...
import com.jgj.demo.service.FeignSearchService;
...
/**
 * Feign调用jgj-search接口示例
 * Created by jgj on 2019/10/22.
 */
@Api(tags = "FeignSearchController", description = "Feign调用jgj-search接口示例")
@RestController
